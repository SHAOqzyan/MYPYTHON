...
class GAIAAV:
	name='public."MWISPGaia"' #table name
	...
	colnames=[GAIA_source_id, GAIA_parallax,GAIA_parallax_err, GAIA_l,  GAIA_b, GAIA_a_g_val,  GAIA_a_g_percentile_lower,\
	
	 GAIA_a_g_percentile_upper,    av16    , av50   ,   av84   , dist16   ,  dist50   , dist84   ]
...
#
		...
		sqlCommand="select * from {} where  l > {} and l < {} and b > {} and b < {} and dist50>{} and dist50<{}  and parallax_error<parallax*{};".format(self.name,sL,eL,sB,eB,lowerDis,upperDis,paraError)
